...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        ...
        gears.wallpaper.maximized("/home/meeks/arch/wallpaper.jpg", s, true)
    end
end
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "f",
        ...
        {description = "jump focus to master", group = "client"}),
...
-- Make mouse cursor follow window that is focused
local function move_mouse_onto_focused_client()
    local c = client.focus
    gears.timer( {  timeout = 0.001,
                autostart = true,
                single_shot = true,
                callback =  function()
...
-- Make gaps disappear if on "max fullscreen" layout
beautiful = require("beautiful") beautiful.gap_single_client = false
